...
namespace SoundId
{
    ...
    const IdType ScuttlebugAttack = "scuttlebug_attack_alt.wav";
    ...
    const IdType BehemothAttack = "beholder_attack.wav";
    const IdType ScuttlebugDeath = "infestation_scuttlebug_death-2.wav";
    const IdType GreaterScuttlebugDeath = "scuttlebug_death_alt.wav";
